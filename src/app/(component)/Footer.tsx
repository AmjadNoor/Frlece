        ...
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-teal-600 flex items-center gap-4 ">
                <Image
                  ...
                  height={60}
                />
                <div className="font-bold text-2xl">Frlece</div>
              </div>

              <p className="mt-4 max-w-xs text-gray-500">
                A freelancing application connects clients with freelancers,
                enabling job postings, project bidding, and secure payments
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              <div>
                <p className="font-medium text-gray-900">Software Services</p>
              ...
              <div>
                <p className="font-medium text-gray-900">IT Services</p>
